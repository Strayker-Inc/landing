...
const HomePage: React.FunctionComponent<IPage & RouteComponentProps<any>> = props => {
  ...
  return (
    <div className="tracking-normal">
      ...
      {/* <!-- CONTACT US --> */}
      <section className="relative flex items-top justify-center min-h-screen gradient dark:bg-green sm:items-center sm:pt-0">
      ...
      <div className="bg-gray-800 dark:bg-gray-800">
        <div className="container flex flex-col items-center px-4 py-6 mx-auto space-y-6 lg:space-y-0 lg:flex-row lg:justify-between">
          <div className="w-48 text-white dark:text-gray-200">
            <div className="flex items-center">
              <img className="h-12" src="./assets/images/logo_symbolic.svg" alt="logo slinqer" />
            </div>
          </div>
          ...
          <div className="flex items-center space-x-6">
            ...
            <a href="#devs" className="text-sm text-white dark:text-gray-300 hover:underline">Our Team</a>

            <a href="https://twitter.com/slinqer" target="_blank" className="text-white dark:text-gray-300" rel="noreferrer">
            ...
            <a href="https://github.com/slinqer" target="_blank" className="text-white dark:text-gray-300" rel="noreferrer">
