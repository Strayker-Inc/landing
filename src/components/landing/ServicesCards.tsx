  ...
  <section className="border-b bg-gray-100 md:pt-8">
    <Fade bottom cascade>
      <div className="text-center md:pb-14">
        ...
        <a href="#contactForm">
          <button className="w-9/12 md:w-3/12 mb-10 mx-auto p-4 text-xl bg-green text-white font-bold rounded-lg transform transition duration-500 hover:scale-150">
