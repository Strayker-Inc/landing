      ...
      <div className="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 py-2" >
        ...
        >
          <ul className="list-reset font-inter lg:flex justify-end flex-1 items-center">
            <li className="toggleColour mr-3">
          ...
          <button id="navButton" className="mx-auto lg:mx-0 hover:underline bg-white text-gray-800 font-inter font-bold rounded-full mt-4 lg:mt-0 py-4 px-8 shadow opacity-75">
            Contacto
          </button>
        </div>
      </div>
