  ...
  <footer className="bg-white dark:bg-white-800">
    <div className="container flex flex-col items-center px-4 py-6 mx-auto space-y-6 lg:space-y-0 lg:flex-row lg:justify-between">
      ...
      <div className="flex items-center space-x-6">
        <a href="#about-us" className="text-sm text-white dark:text-white-300 hover:underline">About us</a>
        <a href="#services" className="text-sm text-white dark:text-white-300 hover:underline">Services</a>
        <a href="#contact" className="text-sm text-white dark:text-white-300 hover:underline">Contact</a>
        <a href="#devs" className="text-sm text-white dark:text-white-300 hover:underline">Our Team</a>

        <a href="https://twitter.com/slinqer" target="_blank" className="text-black dark:text-white" rel="noreferrer">
        ...
        <a href="https://github.com/slinqer" target="_blank" className="text-black dark:text-white-300" rel="noreferrer">
