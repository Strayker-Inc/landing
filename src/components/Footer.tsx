  ...
  <footer>
    <div className="text-center py-10 flex justify-evenly items-center flex-wrap mx-auto">
      ...
      <div className="w-full md:w-auto flex items-center justify-center space-x-6">
        ...
        <a href="#devs" className="text-sm hover:underline">Our Team</a> */}
        ...
        <a href="https://github.com/slinqer" target="_blank" className="text-gray-800" rel="noreferrer">
          <svg viewBox="0 0 30 30" className="w-10 h-10 fill-current">
            ...
            {/* <a href="https://twitter.com/slinqer" className="text-gray-800" target="_blank" rel="noreferrer">
              <img className="w-10  transform transition duration-500 hover:scale-150 text-gray-800" src="./assets/icons/logo-twitter.svg" alt=""/>
            </a>
            <a href="https://instagram.com/slinqerglobal" target="_blank" rel="noreferrer">
              <img className="w-10  transform transition duration-500 hover:scale-150" src="./assets/icons/logo-instagram.svg" alt=""/>
            </a>
            <a href="https://slinqer.medium.com" target="_blank" rel="noreferrer">
              <img className="w-10  transform transition duration-500 hover:scale-150" src="./assets/icons/logo-medium.svg" alt=""/>
            </a>
            <a href="https://github.com/slinqer" target="_blank" rel="noreferrer">
              <img className="w-10  transform transition duration-500 hover:scale-150" src="./assets/icons/logo-github.svg" alt=""/>
            </a> */}
      </div>
    </div>
  </footer>
